...
source('../Life expectancy/LifeTableFUN.R')
...
# Create plots repeat for all sexes
...
ggsave("../Life expectancy/LE HK vs Japan.jpg",dpi = 300,height = 12,width = 12)
